...
```
## Funzioni che è possibile implementare
...
- void IndovinaNumero(int numeroDaIndovinare, int tentativi, int punteggio, Dictionary<string, List> tentativiUtenti) Funzione per indovinare il numero
- void StampaTentativi(Dictionary<string, List> tentativiUtenti) Funzione per stampare i tentativi degli utenti
- void ChiediNomeUtente(Dictionary<string, List> tentativiUtenti) Funzione per chiedere il nome dell'utente
